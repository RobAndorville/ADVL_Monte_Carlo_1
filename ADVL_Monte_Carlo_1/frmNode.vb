Public Class frmNode
    'This form displays the data in a no value node.
...
#Region " Form Methods - The main actions performed by this form." '===========================================================================================================================
    ...
    Private Sub frmNode_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed

        Main.MatrixOpsList(HostFormNo).SaveOpWindowSettings(ItemName, Me.Left, Me.Top, Me.Height, Me.Width, 0)
        Main.MatrixOpsList(HostFormNo).NodeWindowClosed(ItemName)
    ...
    Private Sub frmNode_Deactivate(sender As Object, e As EventArgs) Handles Me.Deactivate
        Main.MatrixOpsList(HostFormNo).SaveOpWindowSettings(ItemName, Me.Left, Me.Top, Me.Height, Me.Width, 0)
    End Sub
