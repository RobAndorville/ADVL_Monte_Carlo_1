Public Class frmScalar
    'This form displays the data in a Scalar value node.
...
#Region " Form Methods - The main actions performed by this form." '===========================================================================================================================
    ...
    'Public Sub ShowScalarInfo(ByRef DataInfo As MatrixInfo)
    ...
    Private Sub frmScalar_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed

        Main.MatrixOpsList(HostFormNo).SaveOpWindowSettings(ItemName, Me.Left, Me.Top, Me.Height, Me.Width, 0)
        Main.MatrixOpsList(HostFormNo).ScalarWindowClosed(ItemName)
    ...
    Private Sub frmScalar_Deactivate(sender As Object, e As EventArgs) Handles Me.Deactivate
        Main.MatrixOpsList(HostFormNo).SaveOpWindowSettings(ItemName, Me.Left, Me.Top, Me.Height, Me.Width, 0)
    End Sub
