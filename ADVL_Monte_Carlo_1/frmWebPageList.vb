Public Class frmWebPageList
    'The Web Pages form shows a list of Web Pages (Workflows) in the project and has buttons to open and edit the pages.
...
#Region " Form Methods - The main actions performed by this form." '===========================================================================================================================
    ...
    Private Sub lstWebPages_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lstWebPages.SelectedIndexChanged
        ...
        Else
            ...
            Main.Message.Add("Regular expression:" & vbCrLf)
            Main.Message.Add(DescrPattern & vbCrLf & vbCrLf)
